const MotivationalPhrase = () => {
  return (
    <div className="relative z-0 max-w-xl m-auto flex flex-col justify-center items-center text-4xl sm:text-6xl font-medium text-gray-200">
      <p className="mr-20 sm:mr-36">Work Hard</p>
      <p className="ml-20 sm:ml-36">
        But <span className="text-pink-600 font-bold">SMART</span>
      </p>
      <div className="w-24 h-24 sm:w-32 sm:h-32 absolute -z-10 left-0 -rotate-12 grayscale-[100%] opacity-20">
      ...
      <div className="w-24 h-24 sm:w-32 sm:h-32 absolute -z-10 right-[20px] bottom-[20px] sm:bottom-[40px] rotate-12 opacity-60">
        <svg id="emoji" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">
          <g id="color">
            <line
              x1="16"
