  ...
  return (
    <div className="bg-gradient-to-t from-slate-900 via-slate-900 to-slate-800 h-[80vh] overflow-y-auto overflow-x-hidden text-gray-300 relative flex flex-col gap-16 z-0">
      ...
      <div className="mt-20 mb-12 sm:mt-32 relative z-10">
        <div className="cursor-default opacity-50 hover:opacity-90 absolute -top-[50px] left-[150px] -z-20 transition-all ease-in-out delay-150 duration-300 hover:translate-x-10">
          <div
            className={`text-9xl text-pink-500 font-extrabold relative z-10`}
          >
            <p
      ...
      <div className="mx-4 sm:mx-6 relative z-10">
        <MyIDCard />
        <div className="cursor-default absolute -right-[370px] -bottom-[180px] w-full -z-20 transition-all ease-in-out delay-150 duration-300 hover:-translate-x-10 rotate-90">
