...
const DateTimeInfo = ({ openInfo, dateTimeInfoRef }: any) => {
  return (
    <div
      ref={dateTimeInfoRef}
      className={`${
    ...
    >
      <h3 className="font-bold text-xl border-b-2 pb-1 border-[#373737] text-center mb-3">
        Interesting Info 🧐
      </h3>
      <div>
        <div className="flex items-center gap-3 p-3 bg-[#5e5e5e] bg-opacity-20 rounded-lg hover:bg-gray-50 hover:bg-opacity-20 transition ease-in-out">
          ...
          <div>
            ...
            <p className="font-regular">
              Yes, but you have to give me accreditation
            </p>
          </div>
        </div>
      </div>
